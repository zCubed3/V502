...
namespace V502 {
    ...
    const instruction_t OPERATIONS[256] = {
            ...
            /* B */ OP_BCS, OP_LDA, INVLID, INVLID, OP_LDY, OP_LDA, OP_LDX, INVLID, INVLID, OP_LDA, OP_TSX, INVLID, OP_LDY, OP_LDA, OP_LDX, INVLID,
            /* C */ INVLID, INVLID, INVLID, INVLID, INVLID, INVLID, INVLID, INVLID, OP_INC, OP_CMP, OP_DEC, INVLID, INVLID, INVLID, INVLID, INVLID,
            /* D */ OP_BNE, INVLID, INVLID, INVLID, INVLID, INVLID, INVLID, INVLID, INVLID, INVLID, INVLID, INVLID, INVLID, INVLID, INVLID, INVLID,
